...
for (const city of cities) {
  ...
  if (rumorPanel && city.rumors && city.rumors.length > 0) {
    ...
    const rt1 = rumorDescendants.find(o => o.name.startsWith('RumorText') && !o.name.includes(' 2') && !o.name.includes(' 3'))
    const rt2 = rumorDescendants.find(o => o.name.startsWith('RumorText 2'))
    const rt3 = rumorDescendants.find(o => o.name.startsWith('RumorText 3'))

    const btn1 = rumorDescendants.find(o => o.name.startsWith('Continuar Boton') && !o.name.includes(' 2') && !o.name.includes(' 3'))
...
console.log('FINAL REBUILD COMPLETE WITH DESCENDANTS!')
